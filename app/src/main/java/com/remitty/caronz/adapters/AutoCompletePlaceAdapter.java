...
public class AutoCompletePlaceAdapter extends ArrayAdapter<PlaceAutoComplete> {
    ViewHolder holder;
    Context context;
    List<PlaceAutoComplete> Places;
    private Activity mActivity;

    public AutoCompletePlaceAdapter(Context context, List<PlaceAutoComplete> modelsArrayList, Activity activity) {
